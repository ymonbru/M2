...
/-- check if the expression is of the form a ≫ b = c ≫ d and gives a, b, c and d-/
def is_square_lhs (e : Expr) : Option <| Expr × Expr × Expr × Expr := do
  ...
  return (e1.getArg! 5, e1.getArg! 6, e2.getArg! 5, e2.getArg! 6)

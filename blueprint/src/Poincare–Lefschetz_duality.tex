...
\begin{lemma}\label{lem:poincare-lefschetz_duality}
    \uses{def:pushforward_of_K-sheaf, def:pullback_of_K-sheaf, def:exceptional_pushforward_of_K-sheaf,lem:Homotopy_k-sheaf_axioms_for_singular_chain,lem:chech_comm_with_exceptional, def:chech_of_compact_sup_of_sh}
